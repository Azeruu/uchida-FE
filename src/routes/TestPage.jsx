...
export default function TestPage() {
  ...
  const loadConfig = async () => {
    try {
      ...
      if (res.ok && data.data) {
        ...
        // Use questionCount from admin config, not pairs length
  ...
  const generateQuestion = useCallback(() => {
    if (
      ...
      // Fallback: generate random numbers 3-9
  ...
  const finishTest = useCallback(
    async (finalAnswers) => {
      ...
      const score = (correctCount / totalQuestions) * 100;
       const isPassed = correctCount >= 525; // Minimal semua soal benar untuk lulus
            ...
            <div className="mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mb-2">
               ...
               <p className="text-gray-600 mb-4">
                 Anda akan mengerjakan <strong>{totalQuestions} soal</strong> penjumlahan dalam{" "}
                 <strong>{Math.floor(timeLeft / 60)} menit</strong>.
               </p>
               <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-sm text-yellow-800">
                 <strong>Persyaratan Kelulusan:</strong> Harus menjawab benar <strong> 525 soal</strong> untuk lulus.
               </div>
              ...
              <div className="grid grid-cols-4 gap-4 text-center mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    {testResult.isPassed ? "Semua benar!" : `Butuh ${totalQuestions} benar`}
                  </div>
                </div>
              </div>
